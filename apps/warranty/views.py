...
@extend_schema_view(
    list=extend_schema(
        tags=["Warranty"],
        summary="List warranties (Admin only)",
    ),
    retrieve=extend_schema(
        tags=["Warranty"],
        summary="Retrieve warranty by ID",
    ...
    create=extend_schema(
        tags=["Warranty"],
        summary="Register E-Warranty",
        description="Register a new E-Warranty (approval required).",
    ),
    update=extend_schema(
        tags=["Warranty"],
        summary="update E-Warranty",
        description="update a E-Warranty",
    ),
    partial_update=extend_schema(
        tags=["Warranty"],
        summary="update E-Warranty",
...
class WarrantyViewSet(viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        if self.action in ["destroy", "approve", "reject","update", "partial_update"]:
    ...
    @extend_schema(
        tags=["Warranty"],
        summary="Register E-Warranty",
        request=WarrantyCreateSerializer,
    )
    def create(self, request, *args, **kwargs):
        serializer = self.get_serializer(data=request.data)
